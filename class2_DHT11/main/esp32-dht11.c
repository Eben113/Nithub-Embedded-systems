...
//function to keep waiting for the state to change to the state argument and then return time elapsed in microsecs
//or for timeout to elapse and then return -1
...
//set pin to zero wait for hold_time_us and then set pin to 1
